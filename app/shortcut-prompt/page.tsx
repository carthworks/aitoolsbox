...
export default function PromptShortcutsApp() {
  ...
  const [activeShortcuts, setActiveShortcuts] = useState<typeof PROMPT_SHORTCUTS[0][]>([]);
  ...
  const addShortcut = useCallback((shortcut: typeof PROMPT_SHORTCUTS[0]) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <header className="mb-8 text-center">
          ...
          <p className="text-gray-600 mt-2">100 powerful shortcuts to enhance your AI interactions</p>
        </header>

        {/* Inline message area (replaces alert) */}
        {message && (
          <div
            role="status"
            aria-live="polite"
            ...
            <>
              <div className="mb-4">
                ...
                <div
                  ...
                  className="flex flex-wrap gap-2 min-h-[40px] p-2 border border-gray-300 rounded-lg bg-gray-50"
                >
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start">
                  ...
                  <span>Use commands like /ELI5 to modify your prompts</span>
                </li>
                <li className="flex items-start">
                  <span className="text-indigo-600 mr-2">•</span>
                  <span>Combine multiple commands for complex requests</span>
                </li>
                <li className="flex items-start">
                  <span className="text-indigo-600 mr-2">•</span>
                  <span>Click the star to save favorites</span>
                </li>
                <li className="flex items-start">
                  <span className="text-indigo-600 mr-2">•</span>
                  <span>Click the copy icon to copy to clipboard</span>
                </li>
                <li className="flex items-start">
                  <span className="text-indigo-600 mr-2">•</span>
                  <span>Click the + button to add shortcuts to your prompt</span>
                </li>
              </ul>
            </div>
          </aside>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      <div className="flex items-center gap-2">
                        <code id={`sc-${shortcut.id}`} className="bg-indigo-100 text-indigo-800 text-sm font-mono px-2 py-1 rounded">
                          {shortcut.command}
                        </code>
        ...
        <footer className="mt-12 text-center text-sm text-gray-500">
          ...
          <p>100 LLM Prompt Shortcuts • Data Engineering Tamil</p>
          <p className="mt-2">
            <a href="https://tablenotfound.com/" className="text-indigo-600 hover:underline">
              Source: TableNotFound.com
            </a>
          </p>
        </footer>
      </div>
